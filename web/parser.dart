...
class SaveWriter {
	static void header(StringBuffer buffer) {
		buffer.writeln("-- This file was generated by the M-RWDK (Modern RWDK Reassembly Web Development Kit)");
		buffer.writeln("-- M-RWDK is a fork by Luexks of the RWDK");
		buffer.writeln("-- Original RWDK was written by TTFTCUTS");
		buffer.writeln("-- The original RWDK is an independent project and in no way affiliated with Anisoptera Games.");
		buffer.writeln("");
	}
